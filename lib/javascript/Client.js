...
function kb_phylosift(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_phylosift = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_phylosift.run_phylosift",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_phylosift.status",
